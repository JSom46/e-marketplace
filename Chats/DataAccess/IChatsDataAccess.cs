...
public interface IChatsDataAccess
{
    ...
    /// <param name="includeMessages">Should Message objects related to the chat be included.</param>
    /// <returns>An <seealso cref="IEnumerable{Chat}"/> of <seealso cref="Chat"/> objects that contains data of searched chats.</returns>
    ...
    /// <returns>An <seealso cref="Announcement"/> object that contains data of searched announcement or null,
    /// if such announcement does not exist.</returns>
    ...
    /// <returns>A <seealso cref="Message"/> object containing data of searched message or null, if such message does not exist.</returns>
